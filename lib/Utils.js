...
var Utils = {
    ...
    verifyCoachPermissions: function (user) {
        return !user || !user.get("userGroup") || user.get("userGroup") !== "coach"  ? Promise.reject(Messages.error.ERROR_UNAUTHORIZED) : Promise.resolve();
    },
    verifyEqualIds: function(a,b){
        return a!==b ? Promise.reject(Messages.error.ERROR_UNAUTHORIZED) : Promise.resolve()
    },
    makeRandomPass: function (size) {
        var text = "";
